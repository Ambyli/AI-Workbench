...
| [`vllm/docker-compose.vllm.yml`](vllm/docker-compose.vllm.yml) | `qwen3.6`, `qwen3.8`, `vllm-qwen-vl`, `muse-glimmer` | `8002`, `8003`, `8006`, `8018` | [VLLM.md](vllm/VLLM.md) · [GPU_SHARING_GUIDE.md](GPU_SHARING_GUIDE.md) |
